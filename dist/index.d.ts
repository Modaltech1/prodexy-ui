...
declare function ChartTooltipContent({ active, payload, label, className, indicator, hideLabel, hideIndicator, labelFormatter, labelClassName, formatter, color, nameKey, labelKey, }: TooltipProps<number, string> & React.ComponentProps<'div'> & {
    hideLabel?: boolean;
